...
export interface GooeyNavProps {
  ...
  activeItem?: string;
  onItemClick?: (href: string) => void; // 👈 ADD THIS
}
...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  useEffect(() => {
    ...
    const newIndex = items.findIndex(item => item.href === `#${activeItem}`);
      ...
      <style>
        {`
          :root {
            ...
            --color-1: #ec38bc;  /* vibrant pink */
            --color-2: #7303c0;  /* violet */
            --color-3: #00ffff;  /* neon blue */
          }
          .effect {
            position: absolute;
            opacity: 1;
